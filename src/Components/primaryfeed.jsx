...
function Primaryfeed() {
  ...
  //     await setisuserLoggedIn(checkloggedIn)
  //     console.log("this is isuserlogged in >>>>>>", isuserLoggedIn, checkloggedIn)
  //   })()
  // }, [])
        ...
        <div className="upper-icons">
          ...
          {(() => {
            if (IS_USER_LOGGED_IN != null) {
              return <Link to="/addpost" className="addpost ">
                <div>
              ...
              return <Link to="/login" className="addpost ">  <div><button className="addpost-button" >
                <AddIcon />
               Add Post
              </button>
              </div>
      ...
      <div className="secondary-container">
        ...
        <div className="sidebar">
          ...
          >
            ...
            <a href="/about" style={{textDecoration: "none", color: "inherit"}} className={"sidemenu-btn"}>
              <SettingsIcon className="menu-icon-each" />
               About Us
            </a>
            <a href="https://www.instagram.com/quink_post/" style={{textDecoration: "none", color: "inherit"}} className="sidemenu-btn">
              <InstagramIcon className="menu-icon-each" />
              Instagram
            </a>
            <a href="https://www.facebook.com/quinkpost.post/" style={{textDecoration: "none", color: "inherit"}} className="sidemenu-btn">
              <FacebookIcon className="menu-icon-each" />
              Facebook
            </a>
            <a href="https://www.linkedin.com/company/quinkpost" style={{textDecoration: "none", color: "inherit"}} className="sidemenu-btn">
            ...
            if (IS_USER_LOGGED_IN != null) {
              ...
              return (
                ...
                >
                  ...
                  />
                  <Link to="/login" className="loginpost" style={{ top: "33%" }}>
                    <button className="addpost-button" style={{ paddingBottom: "5px", paddingTop: "5px" }}>
                      <ExitToAppIcon fontSize="small" style={{ marginRight: "11px" }} />
                      Sign In
                    </button>
                  </Link>
                  <Link to="/login" className="loginpost" style={{ top: "62%" }}>
                    <button className="addpost-button" style={{ paddingBottom: "5px", paddingTop: "5px" }}>
                      <PersonAddIcon fontSize="small" style={{ marginRight: "11px" }} />
                      Sign Up
                    </button>
                  </Link>
                </div>
