      ...
      <div className="secondary-container">
        ...
        <div className="sidebar">
          ...
          >
            ...
            <div className={"sidemenu-btn"}>
              <Link to='/accountsetting' className='account-setting'>
            ...
            >
              <div className="profile-info">
                ...
                <div className="profile-names">
                  <div className="profile-displayname">{(() => { if (layerUser) { return layerUser.user.userName } })()}</div>
                  <div className="profile-username">{(() => { if (layerUser) { return layerUser.user.firstName } })()}</div>
                </div>
              </div>
              <div className="profilesecondary">
                <div className="profile-detail">
                  <div className="profile-detail-each">Quinks</div>
                  <div className="number">{(() => { if (layerUser) { return layerUser.user.post.length } })()}</div>
                </div>
                <div className="line"></div>
                <div className="profile-detail">
                  <div className="profile-detail-each">followers</div>
                  <div className="number">{(() => { if (layerUser) { return layerUser.user.followers.length } })()}</div>
                </div>
                <div className="line"></div>
                <div className="profile-detail">
                  <div className="profile-detail-each">following</div>
                  <div className="number">{(() => { if (layerUser) { return layerUser.user.followings.length } })()}</div>
                </div>
              </div>
            </div>
          </Link>
